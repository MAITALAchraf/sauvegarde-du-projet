...
<body>
    ...
    <h1 style="font-size: 15px;margin-left: 231px;">SQLI SC JAVA</h1>      
		...
		<div align="center">
			...
			<form:form action="" modelAttribute="produit" method="post" style="width:50%">
				<form:hidden path="id"/>
			  ...
			  <input type="submit"  value="Edit" class="btn btn-primary" style="padding-left: 30px;padding-right:  30px;"> 
